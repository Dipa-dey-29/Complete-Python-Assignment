...
# Creating a string that contains a simple bio data
bio_data = "Name: Dipa Dey, Age: 25, Country: Bangladesh"
...
# Using formatted string to include data from the dictionary
formatted_str = f"Name: {person_info['name']}, Age: {person_info['age']}, Country: {person_info['country']}, Nationality: {person_info['nationality']}"
print(formatted_str)
print ("\n")
...
def count_characters():
    ...
    # Iterate over each character in the string and count frequencies
...
# Call the function for the first input
count_characters()

# Call the function again for the second input
#count_characters()
...
hashtags = re.findall(pattern, text_with_hashtags)
...
# Regex pattern
pattern = r"(\+880|0088|0)1[3-9]\d{8}|\b(\+880|0088|0)1[3-9]\d{2}-\d{6}\b"
