...
student = {
    ...
    'grades': [
        {'subject': 'DS', 'marks': 85},
        {'subject': 'Numerical method', 'marks': 90},
        {'subject': 'OS', 'marks': 88}
    ]
}
...
# Adding a new subject and marks to the grades list
student['grades'].append({'subject': 'ML', 'marks': 92})

# Modifying an existing grade
for grade in student['grades']:
    if grade['subject'] == 'Numerical method':
        grade['marks'] = 95  # Updating marks 

# Removing a subject (removing OS subject)
student['grades'] = [grade for grade in student['grades'] if grade['subject'] != 'OS']

# Adding a new key-value pair for the student's address
student['address'] = 'Chittagong,Bangladesh'

# Modifying the student's name
student['name'] = 'Dipannita dey'
