...
# Creating a 3x3 matrix (2D list)
matrix = [[1, 2, 3],[4, 5, 6],[7, 8, 9]]


# Accessing elements in the matrix
print("First row_first column:", matrix[0][0])
print("Second row_second column:", matrix[1][1]) 
print("Third row, third column:", matrix[2][2])
...
#iterating matrix
for i in range(3): #row iteration
    for j in range(3):  # column Iteration
        print(f"position ({i}, {j}):", matrix[i][j])
...
my_tuple = (101, "Dipa Dey", 3.5687, True)
print(my_tuple[0])
print(my_tuple[1])
print(my_tuple[2])
print(my_tuple[3])
...
info = {}
info[(1,"Dips","CSE")] = {"Age ":24,"CGPA" : 3.75}
info[(102,"Y",10)] = {"Age" : 23,"Department ":"CSE"} 
info[(103,"Z",9)] = {"Age" : 24, "Department":"EEE"}

print("Information of 1 : ",info[(1,"Dips","CSE")])
print("Information of 102 : ",info[(102,"Y",10)])
print("Information of 103 : ",info[(103,"Z",9)])
print("\n")
...
# Sorting list by grades
students_sorted_by_grade = sorted(students, key=lambda x: x[1], reverse=True)
